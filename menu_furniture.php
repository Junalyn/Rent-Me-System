...
<div class="animated Bounce container-fluid" style="margin-top:80px;">
	
  <div class="container">
<div class="row">
          <?php include('paginate_furniture.php') ?>
            <div class="panel panel-primary">
                        ...
                        <div class="col-lg-12" style="padding-left: 0; padding-right: 0;" >
                            <form action="menu_furniture.php" method="get" >
                              ...
                              <table class="table table-striped table-hover table-bordered ">
                                <tbody><tr>
                                    ...
                                    <tr>
                                      ...
                                      <td style = "text-align: center;">
                                          <!-- ********************** VIEW BUTTON ************************** -->
                                        <a href="view.php?item_id=<?php echo $res["item_id"]; ?>">
                            ...
                            for ($i = 1; $i <= $last; $i++) {
                              if ($i == $pagenum) {
                                ?>
                                  ...
                                  ?>
                                  <li><a href="menu_furniture.php.php?pagenum=<?php echo $i; ?>&keyword=<?php echo $_GET["keyword"]; ?>" class="links"  onclick="displayRecords('<?php echo $page_limit; ?>', '<?php echo $i; ?>');" ><?php echo $i ?></a></li>
                                  <?php }
                                }
                                  ?>
                          </ul>
