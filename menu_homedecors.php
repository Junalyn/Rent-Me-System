...
<div class="animated SlideInDown container-fluid">
  
<div class="container" style="margin-top:80px;">
<div class="row">
          <?php include('paginate_homedecors.php') ?>
            <div class="panel panel-primary">
                        ...
                        <div class="col-lg-12" style="padding-left: 0; padding-right: 0;" >
                            <form action="menu_homedecors.php" method="get" >
                            ...
                            for ($i = 1; $i <= $last; $i++) {
                              if ($i == $pagenum) {
                                ?>
                                  ...
                                  ?>
                                  <li><a href="view.php?pagenum=<?php echo $i; ?>&keyword=<?php echo $_GET["keyword"]; ?>" class="links"  onclick="displayRecords('<?php echo $page_limit; ?>', '<?php echo $i; ?>');" ><?php echo $i ?></a></li>
                                  <?php }
                                }
                                  ?>
                          </ul>
